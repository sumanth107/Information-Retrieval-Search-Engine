...
***We have tried 5 different methods and to run each method one can easily uncomment the relevant part.***
	Legend to access the relevant methods:
	1. Spell Check - main.py (line 74-75)
	2. Query Expansion - main.py (line 99-101)
	3. Vector Space Model - informationRetrieval.py (line 108-148)
	4. Latent Semantic Analysis - informationRetrieval.py (line 150-190)
	5. BM25 Model - informationRetrieval.py (line 193-213)
